  ...
  if (item && item.type === 'item') {
    ...
    if (item.breadcrumbs !== false) {
      breadcrumbContent = (
        <Card
          sx={{
            marginBottom: card === false ? 0 : theme.spacing(ActionTypes.GRID_SPACING),
        ...
        >
          ...
          {card === false && divider !== false && <Divider sx={{ borderColor: theme.palette.primary.main, mb: ActionTypes.GRID_SPACING }} />}
        </Card>
      );
    }
  }
